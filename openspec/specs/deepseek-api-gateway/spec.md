...
#### Scenario: No provider-call persistence in this slice
- **WHEN** probe succeeds or fails
- **THEN** no provider-call, review-run, budget, finding, or prompt table row is inserted for the gateway probe
