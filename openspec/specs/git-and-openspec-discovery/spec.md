# git-and-openspec-discovery

## Purpose

Read-only inspection of Git and OpenSpec state for registered local projects; fail-closed outcomes; persist inspection timestamp and structured discovery results; expose operator-visible API/console success and blocked/error paths; never mutate target repositories or execute delivery workflows.
