...
Deterministic automated test outputs for the baseline MUST be captured under `openspec/changes/chg-w00-s02-nx-angular-nest-baseline/evidence/`. This slice MUST NOT rely on Playwright e2e, Testcontainers, or CI workflow ownership for its required evidence.
