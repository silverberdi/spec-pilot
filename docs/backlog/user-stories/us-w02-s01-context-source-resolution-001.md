# `us-w02-s01-context-source-resolution-001` — Deliver core behavior

## Parent

- Wave: `w02`
- Slice: `w02-s01-context-source-resolution`
- Expected OpenSpec change: `chg-w02-s01-context-source-resolution`
- Implementer: `cursor`

## Story

As the SpecPilot operator, I need to implement the core behavior of resolve stage-specific configured source sets. so that the product advances with bounded, verifiable behavior.

## Acceptance criteria

1. The slice delivers the explicitly declared capability: Resolve stage-specific configured source sets.
