# `us-w06-s02-implementation-traceability-review-003` — Deliver operational experience
...
As the SpecPilot operator, I need this slice to trace code and tests to requirements and tasks. so that the product advances with verifiable, bounded behavior.
