# `us-w02-s03-context-bundle-manifest-002` — Provide validation and evidence
...
As the SpecPilot operator, I need this slice to create immutable bundle manifests, hashes, and token estimates. so that the product advances with verifiable, bounded behavior.
