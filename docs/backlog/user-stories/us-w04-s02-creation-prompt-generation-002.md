# `us-w04-s02-creation-prompt-generation-002` — Provide validation and evidence
...
As the SpecPilot operator, I need this slice to generate executor-specific complete creation prompt. so that the product advances with verifiable, bounded behavior.
