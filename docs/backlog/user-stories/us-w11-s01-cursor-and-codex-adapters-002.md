# `us-w11-s01-cursor-and-codex-adapters-002` — Provide validation and evidence
...
As the SpecPilot operator, I need this slice to add supervised executor adapters. so that the product advances with verifiable, bounded behavior.
