# `us-w02-s01-context-source-resolution-002` — Provide validation and evidence
...
As the SpecPilot operator, I need this slice to resolve stage-specific configured source sets. so that the product advances with verifiable, bounded behavior.
