# `us-w03-s04-findings-prompts-and-history-001` — Deliver core behavior

## Parent

- Wave: `w03`
- Slice: `w03-s04-findings-prompts-and-history`
- Expected OpenSpec change: `chg-w03-s04-findings-prompts-and-history`
- Implementer: `cursor`

## Story

As the SpecPilot operator, I need to implement the core behavior of persist findings and consolidated prompts with history. so that the product advances with bounded, verifiable behavior.

## Acceptance criteria

1. The slice delivers the explicitly declared capability: Persist findings and consolidated prompts with history.
