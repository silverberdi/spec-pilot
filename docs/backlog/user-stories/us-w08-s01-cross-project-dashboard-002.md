# `us-w08-s01-cross-project-dashboard-002` — Provide validation and evidence
...
As the SpecPilot operator, I need this slice to unified status, filters, attention queues, and budget. so that the product advances with verifiable, bounded behavior.
