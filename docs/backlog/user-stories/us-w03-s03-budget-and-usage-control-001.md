# `us-w03-s03-budget-and-usage-control-001` — Deliver core behavior

## Parent

- Wave: `w03`
- Slice: `w03-s03-budget-and-usage-control`
- Expected OpenSpec change: `chg-w03-s03-budget-and-usage-control`
- Implementer: `cursor`

## Story

As the SpecPilot operator, I need to implement the core behavior of estimate, reserve, reconcile, and hard-block monthly budget. so that the product advances with bounded, verifiable behavior.

## Acceptance criteria

1. The slice delivers the explicitly declared capability: Estimate, reserve, reconcile, and hard-block monthly budget.
