# `us-w08-s03-accessibility-i18n-and-theme-002` — Provide validation and evidence
...
As the SpecPilot operator, I need this slice to spanish-first i18n-ready accessible light/dark/system UI. so that the product advances with verifiable, bounded behavior.
