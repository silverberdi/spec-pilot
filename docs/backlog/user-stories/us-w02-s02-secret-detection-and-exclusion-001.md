# `us-w02-s02-secret-detection-and-exclusion-001` — Deliver core behavior
...
As the SpecPilot operator, I need to implement the core behavior of prevent secret disclosure and block unsafe bundles. so that the product advances with bounded, verifiable behavior.

## Acceptance criteria

1. The slice delivers the explicitly declared capability: Prevent secret disclosure and block unsafe bundles.
