# `us-w05-s04-planning-review-experience-001` — Deliver core behavior

## Parent

- Wave: `w05`
- Slice: `w05-s04-planning-review-experience`
- Expected OpenSpec change: `chg-w05-s04-planning-review-experience`
- Implementer: `cursor`

## Story

As the SpecPilot operator, I need to implement the core behavior of render findings, evidence, comparisons, and iteration history. so that the product advances with bounded, verifiable behavior.

## Acceptance criteria

1. The slice delivers the explicitly declared capability: Render findings, evidence, comparisons, and iteration history.
