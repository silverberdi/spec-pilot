# `us-w06-s03-ready-for-verify-decision-002` — Provide validation and evidence
...
As the SpecPilot operator, I need this slice to issue ready-for-verify or correction prompt. so that the product advances with verifiable, bounded behavior.
