# `us-w03-s01-deepseek-api-gateway-001` — Deliver core behavior

## Parent

- Wave: `w03`
- Slice: `w03-s01-deepseek-api-gateway`
- Expected OpenSpec change: `chg-w03-s01-deepseek-api-gateway`
- Implementer: `cursor`

## Story

As the SpecPilot operator, I need to implement the core behavior of integrate V4 Flash/Pro with structured outputs. so that the product advances with bounded, verifiable behavior.

## Acceptance criteria

1. The slice delivers the explicitly declared capability: Integrate V4 Flash/Pro with structured outputs.
