# `us-w01-s04-project-dashboard-001` — Deliver core behavior

## Parent

- Wave: `w01`
- Slice: `w01-s04-project-dashboard`
- Expected OpenSpec change: `chg-w01-s04-project-dashboard`
- Implementer: `cursor`

## Story

As the SpecPilot operator, I need to implement the core behavior of display registered projects and discovery health. so that the product advances with bounded, verifiable behavior.

## Acceptance criteria

1. The slice delivers the explicitly declared capability: Display registered projects and discovery health.
