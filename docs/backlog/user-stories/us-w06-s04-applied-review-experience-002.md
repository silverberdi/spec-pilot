# `us-w06-s04-applied-review-experience-002` — Provide validation and evidence

## Parent

- Wave: `w06`
- Slice: `w06-s04-applied-review-experience`
- Expected OpenSpec change: `chg-w06-s04-applied-review-experience`

## Story

As the SpecPilot operator, I need this slice to render implementation evidence and review history. so that the product advances with verifiable, bounded behavior.
