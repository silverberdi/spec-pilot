# `us-w03-s02-review-run-orchestration-002` — Provide validation and evidence
...
As the SpecPilot operator, I need this slice to persist and execute review run state machine. so that the product advances with verifiable, bounded behavior.
