# `us-w08-s01-cross-project-dashboard-001` — Deliver core behavior

## Parent

- Wave: `w08`
- Slice: `w08-s01-cross-project-dashboard`
- Expected OpenSpec change: `chg-w08-s01-cross-project-dashboard`
- Implementer: `cursor`

## Story

As the SpecPilot operator, I need to implement the core behavior of unified status, filters, attention queues, and budget. so that the product advances with bounded, verifiable behavior.

## Acceptance criteria

1. The slice delivers the explicitly declared capability: Unified status, filters, attention queues, and budget.
