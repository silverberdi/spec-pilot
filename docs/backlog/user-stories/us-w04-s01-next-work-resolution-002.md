# `us-w04-s01-next-work-resolution-002` — Provide validation and evidence
...
As the SpecPilot operator, I need this slice to resolve next eligible work generically and via wave/slice configuration. so that the product advances with verifiable, bounded behavior.
