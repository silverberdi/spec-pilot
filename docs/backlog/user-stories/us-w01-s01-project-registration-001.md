# `us-w01-s01-project-registration-001` — Deliver core behavior

## Parent

- Wave: `w01`
- Slice: `w01-s01-project-registration`
- Expected OpenSpec change: `chg-w01-s01-project-registration`
- Implementer: `cursor`

## Story

As the SpecPilot operator, I need to implement the core behavior of register and validate local repositories. so that the product advances with bounded, verifiable behavior.

## Acceptance criteria

1. The slice delivers the explicitly declared capability: Register and validate local repositories.
