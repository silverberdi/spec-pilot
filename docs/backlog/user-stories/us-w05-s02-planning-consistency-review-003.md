# `us-w05-s02-planning-consistency-review-003` — Deliver operational experience
...
As the SpecPilot operator, I need this slice to detect gaps, conflicts, scope creep, and missing evidence tasks. so that the product advances with verifiable, bounded behavior.
