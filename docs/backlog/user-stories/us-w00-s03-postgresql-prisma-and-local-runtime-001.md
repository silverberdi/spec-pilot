# `us-w00-s03-postgresql-prisma-and-local-runtime-001` — Deliver core behavior

## Parent

- Wave: `w00`
- Slice: `w00-s03-postgresql-prisma-and-local-runtime`
- Expected OpenSpec change: `chg-w00-s03-postgresql-prisma-and-local-runtime`
- Implementer: `cursor`

## Story

As the SpecPilot operator, I need to implement the core behavior of create PostgreSQL/Prisma persistence baseline and Docker Compose local runtime. so that the product advances with bounded, verifiable behavior.

## Acceptance criteria

1. The slice delivers the explicitly declared capability: Create PostgreSQL/Prisma persistence baseline and Docker Compose local runtime.
