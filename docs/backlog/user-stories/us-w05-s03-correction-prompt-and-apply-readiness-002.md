# `us-w05-s03-correction-prompt-and-apply-readiness-002` — Provide validation and evidence
...
As the SpecPilot operator, I need this slice to generate one correction prompt or exact apply command. so that the product advances with verifiable, bounded behavior.
