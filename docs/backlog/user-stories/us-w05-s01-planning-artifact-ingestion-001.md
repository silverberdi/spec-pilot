# `us-w05-s01-planning-artifact-ingestion-001` — Deliver core behavior

## Parent

- Wave: `w05`
- Slice: `w05-s01-planning-artifact-ingestion`
- Expected OpenSpec change: `chg-w05-s01-planning-artifact-ingestion`
- Implementer: `cursor`

## Story

As the SpecPilot operator, I need to implement the core behavior of load and correlate proposal/design/specs/tasks. so that the product advances with bounded, verifiable behavior.

## Acceptance criteria

1. The slice delivers the explicitly declared capability: Load and correlate proposal/design/specs/tasks.
