# `us-w11-s03-controlled-orchestration-001` — Deliver core behavior

## Parent

- Wave: `w11`
- Slice: `w11-s03-controlled-orchestration`
- Expected OpenSpec change: `chg-w11-s03-controlled-orchestration`
- Implementer: `cursor`

## Story

As the SpecPilot operator, I need to implement the core behavior of coordinate implement/review/fix loops with hard limits. so that the product advances with bounded, verifiable behavior.

## Acceptance criteria

1. The slice delivers the explicitly declared capability: Coordinate implement/review/fix loops with hard limits.
