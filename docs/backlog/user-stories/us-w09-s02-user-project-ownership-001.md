# `us-w09-s02-user-project-ownership-001` — Deliver core behavior

## Parent

- Wave: `w09`
- Slice: `w09-s02-user-project-ownership`
- Expected OpenSpec change: `chg-w09-s02-user-project-ownership`
- Implementer: `cursor`

## Story

As the SpecPilot operator, I need to implement the core behavior of associate projects/runs/budgets with users. so that the product advances with bounded, verifiable behavior.

## Acceptance criteria

1. The slice delivers the explicitly declared capability: Associate projects/runs/budgets with users.
