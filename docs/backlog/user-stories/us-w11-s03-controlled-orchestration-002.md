# `us-w11-s03-controlled-orchestration-002` — Provide validation and evidence
...
As the SpecPilot operator, I need this slice to coordinate implement/review/fix loops with hard limits. so that the product advances with verifiable, bounded behavior.
