# `us-w02-s04-context-preview-and-approval-001` — Deliver core behavior

## Parent

- Wave: `w02`
- Slice: `w02-s04-context-preview-and-approval`
- Expected OpenSpec change: `chg-w02-s04-context-preview-and-approval`
- Implementer: `cursor`

## Story

As the SpecPilot operator, I need to implement the core behavior of preview content disclosure before first or policy-changing runs. so that the product advances with bounded, verifiable behavior.

## Acceptance criteria

1. The slice delivers the explicitly declared capability: Preview content disclosure before first or policy-changing runs.
