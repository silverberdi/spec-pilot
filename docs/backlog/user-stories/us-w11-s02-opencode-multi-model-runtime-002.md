# `us-w11-s02-opencode-multi-model-runtime-002` — Provide validation and evidence
...
As the SpecPilot operator, I need this slice to add provider-neutral OpenCode runtime. so that the product advances with verifiable, bounded behavior.
