# `us-w04-s03-new-review-console-002` — Provide validation and evidence

## Parent

- Wave: `w04`
- Slice: `w04-s03-new-review-console`
- Expected OpenSpec change: `chg-w04-s03-new-review-console`

## Story

As the SpecPilot operator, I need this slice to expose new review flow and copy action in UI. so that the product advances with verifiable, bounded behavior.
