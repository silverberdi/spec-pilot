# `us-w03-s01-deepseek-api-gateway-002` — Provide validation and evidence
...
As the SpecPilot operator, I need this slice to integrate V4 Flash/Pro with structured outputs. so that the product advances with verifiable, bounded behavior.
