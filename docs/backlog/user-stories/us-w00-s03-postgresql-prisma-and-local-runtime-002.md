# `us-w00-s03-postgresql-prisma-and-local-runtime-002` — Provide validation and evidence
...
As the SpecPilot operator, I need this slice to create PostgreSQL/Prisma persistence baseline and Docker Compose local runtime. so that the product advances with verifiable, bounded behavior.
