# `us-w11-s01-cursor-and-codex-adapters-001` — Deliver core behavior

## Parent

- Wave: `w11`
- Slice: `w11-s01-cursor-and-codex-adapters`
- Expected OpenSpec change: `chg-w11-s01-cursor-and-codex-adapters`
- Implementer: `cursor`

## Story

As the SpecPilot operator, I need to implement the core behavior of add supervised executor adapters. so that the product advances with bounded, verifiable behavior.

## Acceptance criteria

1. The slice delivers the explicitly declared capability: Add supervised executor adapters.
