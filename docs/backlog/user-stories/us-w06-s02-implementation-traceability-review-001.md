# `us-w06-s02-implementation-traceability-review-001` — Deliver core behavior

## Parent

- Wave: `w06`
- Slice: `w06-s02-implementation-traceability-review`
- Expected OpenSpec change: `chg-w06-s02-implementation-traceability-review`
- Implementer: `cursor`

## Story

As the SpecPilot operator, I need to implement the core behavior of trace code and tests to requirements and tasks. so that the product advances with bounded, verifiable behavior.

## Acceptance criteria

1. The slice delivers the explicitly declared capability: Trace code and tests to requirements and tasks.
