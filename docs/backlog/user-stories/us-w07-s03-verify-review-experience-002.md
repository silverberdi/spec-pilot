# `us-w07-s03-verify-review-experience-002` — Provide validation and evidence
...
As the SpecPilot operator, I need this slice to render blocking gates and exact next command. so that the product advances with verifiable, bounded behavior.
