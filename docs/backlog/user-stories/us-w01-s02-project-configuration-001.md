# `us-w01-s02-project-configuration-001` — Deliver core behavior

## Parent

- Wave: `w01`
- Slice: `w01-s02-project-configuration`
- Expected OpenSpec change: `chg-w01-s02-project-configuration`
- Implementer: `cursor`

## Story

As the SpecPilot operator, I need to implement the core behavior of parse, validate, version, and persist project.yaml. so that the product advances with bounded, verifiable behavior.

## Acceptance criteria

1. The slice delivers the explicitly declared capability: Parse, validate, version, and persist project.yaml.
